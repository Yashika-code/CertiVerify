      ...
      <div className="flex flex-col md:flex-row h-[calc(100vh-64px)]">
        ...
        ">
          <button
            ...
            className={`sidebar-btn flex items-center gap-2 whitespace-nowrap md:w-full
              ${isActive("/admin")
          ...
          <button
            ...
            className={`sidebar-btn flex items-center gap-2 whitespace-nowrap md:w-full ml-2 md:ml-0
              ${isActive("/admin/issue")
                ? "bg-green-50 text-green-700"
                : "text-gray-700 hover:bg-gray-100"
              }`}
          >
        ...
        <main className="flex-1 p-6 overflow-y-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {[
              ...
              >
                <div className={`p-4 rounded-full text-xl ${s.color}`}>
                  📊
                </div>
                <div>
                ...
                certificates.map(cert => (
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={() =>
                        window.open(
                          `${backendOrigin}${cert.certificateUrl}`,
                          "_blank"
                        )
                      }
                    >
